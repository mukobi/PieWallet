...
<body>
    <div id="main-container" class="content-main login">
        ...
        <div class="login-box">
            ...
            <div>
            <script async src="https://telegram.org/js/telegram-widget.js?4" data-telegram-login="PayPeerBot" data-size="large" data-onauth="onTelegramAuth(user)" data-request-access="write"></script>
