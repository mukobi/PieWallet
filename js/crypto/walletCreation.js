...
function createPublicKeyHash() {
	...
	var publicKeyHash = rmd160.hex(buffer.Buffer.from(publicKey, 'hex').toString('hex'));
...
function createPublicAddress(publicKeyHash) {
	...
	const step2 = sha256(buffer.Buffer.from(step1, 'hex'));
	console.log(step2);
	// step 3 - create SHA256 hash of step 2
	const step3 = sha256(buffer.Buffer.from(step2, 'hex'));
	console.log(step3);
	...
	//base58.encode(Buffer.from(step4, 'hex'));
	return address;
}
...
},{"elliptic":5}],3:[function(require,module,exports){
...
},{"../package.json":20,"./elliptic/curve":8,"./elliptic/curves":11,"./elliptic/ec":12,"./elliptic/eddsa":15,"./elliptic/utils":19,"brorand":4}],6:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":5,"../curve":8,"bn.js":3,"inherits":34}],8:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":5,"../curve":8,"bn.js":3,"inherits":34}],10:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":5,"../curve":8,"bn.js":3,"inherits":34}],11:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":5,"./key":13,"./signature":14,"bn.js":3,"hmac-drbg":33}],13:[function(require,module,exports){
'use strict';
...
},{"bn.js":3,"minimalistic-assert":35,"minimalistic-crypto-utils":36}],20:[function(require,module,exports){
module.exports={
  "_from": "elliptic",
  "_id": "elliptic@6.4.1",
  "_inBundle": false,
